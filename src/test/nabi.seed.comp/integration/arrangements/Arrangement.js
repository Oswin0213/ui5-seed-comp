sap.ui.define([
	...
	function getFrameUrl(sHash, sUrlParameters) {
		sHash = sHash || "";
		var sUrl = sap.ui.require.toUrl("test/nabi/seed/comp/bootstrapping/openui5.html");
	...
	return Opa5.extend("test.nabi.seed.comp.integration.arrangements.Arrangement", {
