sap.ui.define([
...
], function (jQuery, Log, Button, UIComponent, JSONModel, Device, Filter, FilterOperator) {
	"use strict";

	var Component = UIComponent.extend("nabi.seed.comp.Component", {
	...
	Component.prototype.init = function () {
		...
		Log.info("Yayyy - nabi.seed.comp.Component successfully initialized :-)");
	};
	...
	Component.prototype._getCustomerSelectDialog = function () {
		if (!this._oTSD) {
			this._oTSD = sap.ui.xmlfragment(this.getId(), "nabi.seed.comp.fragment.CustomerTableSelectDialog", this);
