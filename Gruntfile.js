...
module.exports = function (grunt) {
	...
	grunt.initConfig({
		...
		// i.e. converts "nabi.seed.comp" from ui5 app descriptor to "nabi/seed/comp"
				...
				client: {
					openui5: {
						config: {
							...
							preload: "async",
							resourceRoots: {
								"nabi.seed.comp": "./base/src/main/webapp",
								"test.nabi.seed.comp": "http://localhost:8080/test-resources/nabi.seed.comp/"
								//DEPENDENCIES, i.e.
								...
								//"nabi.seed.comp": "http://localhost:8080/..."
							}
						},
						tests: [
							"test/nabi/seed/comp/unit/allTests",
							"test/nabi/seed/comp/integration/AllJourneys"		// remove this in case it takes too long, i.e. tdd/dev time
						]
					}
				},
				reporters: ["progress"],
